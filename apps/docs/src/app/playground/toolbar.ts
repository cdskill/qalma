...
@Component({
  ...
  template: `
    <qalma-toolbar
      class="flex flex-wrap items-center gap-1.5 border-b border-border bg-secondary/40 p-2"
    >
      <button
        type="button"
        [class]="commandClass"
...
export class PlaygroundToolbar {
  ...
  protected readonly commandClass =
    'inline-flex h-8 w-8 items-center justify-center rounded-md border border-border bg-card text-muted-foreground transition hover:border-accent hover:bg-secondary hover:text-foreground disabled:cursor-not-allowed disabled:opacity-45 [&.qalma-command-active]:border-accent [&.qalma-command-active]:bg-accent-subtle [&.qalma-command-active]:text-accent';
  protected readonly colorSwatchClass =
    'inline-flex h-8 w-8 items-center justify-center rounded-md border border-border bg-card transition hover:border-accent hover:bg-secondary disabled:cursor-not-allowed disabled:opacity-45 [&.qalma-command-active]:border-accent [&.qalma-command-active]:bg-accent-subtle';
  protected readonly languageSelectClass =
    'h-8 rounded-md border border-border bg-card px-2 text-xs font-medium text-foreground transition hover:border-accent focus:border-accent focus:outline-none focus:ring-2 focus:ring-ring/30';
