...
<p>Shape text without surrendering UI ownership: try <em>italic</em>, <u>underline</u>, <s>strikethrough</s>, <code>inline code</code>, <mark>highlight</mark>, <span style="color: rgb(124, 76, 43); background-color: rgb(247, 238, 221);">sepia ink</span>, a <span style="color: rgb(15, 41, 71); background-color: rgb(186, 230, 253);">tinted background</span>, formulas like H<sub>2</sub>O and E=mc<sup>2</sup>, mention <span data-qalma-mention data-mention-id="ada-lovelace" data-mention-label="Ada Lovelace" data-mention-trigger="@">@Ada Lovelace</span>, and <a href="https://angular.dev" target="_blank" rel="noopener noreferrer">links</a> with a hover preview.</p>
